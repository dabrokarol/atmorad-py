...
def test_data_io_save_load_sim(sim_context_list, tmp_path):
    for sim_context in sim_context_list:
        ...
        results_2 = DataIO.load_simulation_results(data_io.base_dir)
        ...
        assert config == config_from_checkpoint, (
            "Checkpoint configuration does not match the original."
        )
